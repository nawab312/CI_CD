# CI/CD and Jenkins Complete Knowledge Map
...
| 3.4 | Declarative vs Scripted — key differences, when to choose each | Intermediate |
| 3.5 | Jenkinsfile — anatomy, best practices, version control | Beginner |
| 3.6 | Stages, Steps, and Post Actions | Beginner |
| 3.7 | Parallel Stages — syntax, use cases, fail-fast behavior | Intermediate |
...
| 3.10 | Stash and Unstash — sharing files between stages | Intermediate |
...
| 3.13 | Pipeline Shared Libraries — structure, @Library, vars/, src/ | Advanced |
...
| 4.3 | Pipeline Restart from Stage — checkpoint, limitations | Advanced |
...
| 4.7 | Pipeline Durability Settings | Advanced |
...
| 5.5 | Kubernetes Plugin — dynamic pod agents, podTemplate | Advanced |
| 5.6 | Docker Plugin vs Docker Pipeline Plugin | Intermediate |
| 5.7 | Configuration as Code (JCasC) Plugin | Advanced |
...
| 6.2 | Jenkins + Docker — building images, Docker-in-Docker, best practices | Intermediate |
...
| # | Topic | Difficulty |
|---|------|------------|
| 7.1 | Secrets Management — what NOT to do, what to do | Intermediate |
...
| 8.3 | Ephemeral Agents vs Persistent Agents — tradeoffs | Intermediate |
...
| 9.3 | GitOps vs Push-based CI/CD | Advanced |
...
| 9.7 | Database Migrations in CI/CD | Advanced |
